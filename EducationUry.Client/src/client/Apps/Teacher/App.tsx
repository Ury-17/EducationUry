		...
		<div id='page_wrapper' style={{
			...
			<div className='page page--index' style={{gridColumn: 1, gridRow: 1}}>
				...
				<div  style={{marginTop: '10px'}}>
					...
					{store.filteredTeachers.map((t, m) => <ProjectView store={store} teacher={t} key={m} onEdit={() => store.beginEdit(t.id)} onArchive={() => store.toArchive(t.id)} canArchive={true}/>)}
					{/* </nav> */}
				</div>
			</div>
		</div>
